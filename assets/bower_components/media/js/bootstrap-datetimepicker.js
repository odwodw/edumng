...
!function( $ ) {
	...
	var Datetimepicker = function(element, options) {
		...
		this.component = this.element.is('.date') ? this.element.find('.add-on .icon-th, .add-on .icon-time, .add-on .fa-calendar').parent() : false;
		this.componentReset = this.element.is('.date') ? this.element.find('.add-on .fa-remove').parent() : false;
